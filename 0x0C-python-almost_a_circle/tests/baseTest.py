#!/usr/bin/python3
"""definition unit tests for base.py
...
class TestBase_to_json_string(unittest.TestCase):
    """test for to_json_string method of the base class"""
...
class TestBase_save_to_file(unittest.TestCase):
    ...
    @classmethod
    def tearDown(self):
        """func deleting anyfiles created"""
        try:
...
class TestBase_from_json_string(unittest.TestCase):
    """tests for from_json_string method of base class"""
...
class TestBase_create(unittest.TestCase):
    """tests for create method of base class"""
...
class TestBase_load_from_file(unittest.TestCase):
    """tests for load_from_file_method of base class"""

    @classmethod
    def tearDown(self):
        """func deleting any files created"""
        try:
            os.remove("Rectangle.json")
        except IOError:
            pass
...
class TestBase_save_to_file_csv(unittest.TestCase):
    ...
    @classmethod
    def tearDown(self):
        """func deleting any filescreated"""
        try:
