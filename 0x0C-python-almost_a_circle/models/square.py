...
class Square(Rectangle):
    ...
    @property
    def size(self):
        """func getting/sets size of the square"""
        return self.width
    ...
    def to_dictionary(self):
        """func returning dict representation of the square"""
        return {
            "id": self.id,
            "size": self.width,
            "x": self.x,
    ...
    def __str__(self):
        """func returning print() and str() representation of the square"""
